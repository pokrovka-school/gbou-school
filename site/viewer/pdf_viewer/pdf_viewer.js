...
const DEFAULT_L10N_STRINGS = {
	...
	document_properties_page_size_dimension_string: "{{width}} Г— {{height}} {{unit}} ({{orientation}})",
	document_properties_page_size_dimension_name_string: "{{width}} Г— {{height}} {{unit}} ({{name}}, {{orientation}})",
	...
	free_text2_default_content: "Start typingвЂ¦",
